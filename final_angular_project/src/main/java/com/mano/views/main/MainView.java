...
import com.mano.views.dashboard.DashboardView;
import com.mano.views.masterdetail.UserView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "manowala", shortName = "manowala")
