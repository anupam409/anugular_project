package com.mano.views.masterdetail;

import org.springframework.beans.factory.annotation.Autowired;
import com.mano.backend.BackendService;
import com.mano.backend.Employee;
...
import com.mano.views.main.MainView;

import com.mano.views.masterdetail.UserView.MasterDetailViewModel;

@Route(value = "userdetails", layout = MainView.class)
@PageTitle("Details")
@JsModule("./src/views/masterdetail/master-detail-view.js")
@Tag("master-detail-view")
public class UserView extends PolymerTemplate<MasterDetailViewModel> implements
